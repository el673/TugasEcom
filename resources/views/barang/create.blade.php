...
@section('header', 'Create New Barang')
    ...
    <div class="bg-white shadow-lg rounded-lg p-6">
        ...
        <form method="POST" action="{{ route('barang.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <input type="number" name="harga_produk" id="harga_produk" value="{{ old('harga_produk') }}" required
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>
            ...
            <div>
                ...
                <input type="text" name="asal_daerah" id="asal_daerah" value="{{ old('asal_daerah') }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>
